                    ...
                    <div class="relative shadow-md sm:rounded-lg">
                        ...
                        <style>
                            ...
                            .overflow-auto::-webkit-scrollbar-track {
                                background: #333; /* Màu nền của track trong chủ đề tối */
                            }
                        
                            .overflow-auto::-webkit-scrollbar-thumb {
                                background-color: #555; /* Màu của thanh cuộn trong chủ đề tối */
                                border-radius: 3px; /* Bo góc thành bo tròn */
                            }
                        
                            .overflow-auto::-webkit-scrollbar-thumb:hover {
                                background-color: #777; /* Màu của thanh cuộn khi hover trong chủ đề tối */
                            }
                        </style>
                        ...
                        <div class="overflow-auto" style="max-height: 600px">
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            <img class="w-10 h-10 rounded-full"
                                                src="{{ asset('images/profile-picture-4.jpg') }}" alt="Jese image">
                                            <div class="ps-3">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            type="button" data-modal-target="editUserModal"
                                                ...
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit <3
                                                user</a>
                                        </td>
                                    </tr>
                                    <tr
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <a href="#" type="button" data-modal-target="editUserModal"
                                                ...
                                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit
                                                user</a>
                                            <a href="#" type="button" data-modal-target="removeUserModal"
                                                data-modal-show="removeUserModal"
                            ...
                            <div class="flex justify-center mt-4">
                                <div class="relative z-0 inline-flex h-12 rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                                    <!-- Nút Previous -->
                                    <a href="#" id="prevBtn" class="relative inline-flex items-center px-2 py-2 rounded-l-md border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">
                                    ...
                                    <!-- Các nút số trang -->
                                    <a href="#" class="page-number relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">1</a>
                                    <a href="#" class="page-number relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">2</a>
                                    <a href="#" class="page-number relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">3</a>
                                    ...
                                    <a href="#" class="page-number hidden relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">48</a>
                                    <a href="#" class="page-number hidden relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">49</a>
                                    <a href="#" class="page-number hidden relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">50</a>
                            
                                    <!-- Nút Next -->
                                    <a href="#" id="nextBtn" class="relative inline-flex items-center px-2 py-2 rounded-r-md border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">
                            ...
                            <div id="page-input-dialog" class="hidden fixed inset-0 flex items-center justify-center z-50 bg-gray-800 bg-opacity-75">
                                <div class="bg-white p-6 rounded-lg shadow-lg">
                                    <label for="page-number" class="block text-sm font-medium text-gray-700">Enter page number</label>
                                    <div class="mt-1">
                                        <input type="number" name="page-number" id="page-number" class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                    </div>
                                    <div class="mt-4 flex justify-end">
                                        <button id="page-input-cancel" class="mr-2 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Cancel</button>
                                        <button id="page-input-go" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Go</button>
                                    </div>
                                </div>
                            </div>
    ...
    function generatePagination() {
        ...
        for (let i = 1; i <= totalPages; i++) {
            if (i <= 3 || i >= totalPages - 2) {
                pages += `<a href="#" class="page-number relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">${i}</a>`;
            } else if (!dotsShown && (i === 4 || i === totalPages - 3)) {
                pages += `<span id="dotsBtn" class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 cursor-pointer">...</span>`;
                dotsShown = true; // Đánh dấu là đã hiển thị dấu ba chấm
            } else if (dotsShown && (i === 4 || i === totalPages - 3)) {
                // Không làm gì cả, để không hiển thị dấu ba chấm thứ hai
            } else {
                pages += `<a href="#" class="page-number hidden relative inline-flex items-center px-4 py-2 border border-gray-300 bg-gray-700 text-sm font-medium text-gray-400 hover:bg-gray-600 dark:bg-gray-700 dark:text-gray-400 dark:hover:bg-gray-600">${i}</a>`;
            }
        }
...
@endsection
>>>>>>> c780b03e2f7c1e23732557818e68bc579e02972e
