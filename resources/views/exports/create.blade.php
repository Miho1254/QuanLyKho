                        ...
                        <div class="max-w mx-autop-8 rounded shadow" style="height: 100%;">
                            ...
                            <form id="warehouse-form" class="px-5" action="#" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <p id="product_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">Xuất kho</p>
                                </div>
                                <div class="mb-4">
