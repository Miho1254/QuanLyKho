...
function updateProductsInput() {
    ...
    // Log giá trị của input ẩn để kiểm tra
    console.log('Hidden products input value:', productsInput.value);
                ...
                function updateProductsInput() {
                    productsInput.value = JSON.stringify(products);
                    console.log('Products input value:', productsInput.value); // Add this line for debugging
                }

                exportsForm.addEventListener('submit', function (event) {
                    updateProductsInput(); // Ensure hidden input is updated
                    console.log('Submitting form with products:', productsInput.value); // Debugging log
                });
            });
        </script>
    </div>
