...
@section('content')
    <div class="flex h-full w-full mb-10">
        ...
        <form action="{{ route('admins.store') }}" method="POST" class="w-full px-5">
            @csrf
            ...
            <!-- Role selection -->
            <div class="relative z-0 w-full mb-5 group">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chức vụ</label>
                <div class="flex items-center mb-4">
                    <input type="radio" id="role_admin" name="role" value="admin" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" required>
                    <label for="role_admin" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Admin</label>
                </div>
                <div class="flex items-center">
                    <input type="radio" id="role_user" name="role" value="user" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="role_user" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">User</label>
                </div>
            </div>
                    ...
                    <div id="dropzone-container" class="flex items-center justify-center w-full">
                        <label for="dropzone-file"
                            ...
                            <div id="dropzone-content" class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG hoặc GIF (Tối đa 800x400px)</p>
                            </div>
            ...
            <div class="relative z-0 w-full mb-5 group">
                <button type="submit"
                    class="w-full text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Thêm
                    người dùng</button>
            </div>
        </form>
    </div>
