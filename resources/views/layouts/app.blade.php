            ...
            <div class="mx-auto w-full max-w-screen-xl ">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-5 gap-8 sm:gap-4 sm:grid-cols-1">
                        <div>
                            <ul
                                class="text-gray-500 dark:text-gray-400 font-medium mt-3>
                                <li class="mb-4">
                                ...
                                <div class="flex items-center mt-4">
                                    ...
                                    <p class="text-sm">
                                        ...
                                        <span class="ml-1 text-base">Đường DC13, Sơn Kỳ, Tân Phú, Thành phố Hồ Chí Minh,
                                            Việt Nam</span>
                                    </p>
                                </div>
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Nhập kho
                                &amp; nhân sự
                            </h2>
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4 mt-1">
