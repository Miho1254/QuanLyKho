        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('categories.index') }}"
                    ...
                    <span class="ml-3">Loại sản phẩm</span>
                </a>
            </li>
            ...
            @if (Auth::check())
                ...
                @else
                    <li style="display: none;">
                        <a href="{{ route('admins.index') }}"
                            class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
                            <svg class="flex-shrink-0 w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400 group-hover:text-gray-
                <svg class="flex-shrink-0
                                w-6 h-6 text-gray-400 transition duration-75 dark:text-gray-400
